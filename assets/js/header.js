...
document.addEventListener("DOMContentLoaded", () => {
  ...
  header.innerHTML = `
    <div class="w-full max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
      <!-- Left: Logo -->
      ...
      <!-- Right: Burger + dropdown (desktop & mobile) -->
      <div class="relative">
        <button id="zd-menu-btn" aria-expanded="false" aria-controls="zd-menu"
                class="flex flex-col items-center justify-center gap-1.5 p-2 focus:outline-none"
                title="Menu">
